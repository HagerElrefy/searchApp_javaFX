...
//import ir_test.ir2023.HomeController;
//import static ir_test.util.Utilities.applyStemming;
//import static ir_test.util.Utilities.applyStopWordsRemoval;
//import static ir_test.util.Utilities.normalizeText;
import ir2023.HomeController;
import java.io.*;
import java.util.*;
import static util.Utilities.applyStemming;
import static util.Utilities.applyStopWordsRemoval;
import static util.Utilities.lemmatize;
...
public class TermDocumentMatrix {
    ...
    public TermDocumentMatrix() throws FileNotFoundException {
        File file = new File("D:\\app\\src\\algorithms\\cici.txt");
...
//        System.out.println(c);
    ...
    public List<String> notSearch(String textToSearch) {
        List<String> splitText = Arrays.asList(textToSearch.split("\\s+"));
        List<String> foundDocuments = new ArrayList<>();
    ...
    public List<String> booleanSearch(String textToSearch) {
            ...
            switch (localTerms.get(1)) {
                ...
                case "OR" : {
                    ...
                    if (resultOfOr.isEmpty()) {
                        return Arrays.asList("Not Found with or query");
                    } else {
                        return resultOfOr;
                    }
                }
                default : {
                    return Arrays.asList("Wrong query!!");
                }
            }
        ...
        return Arrays.asList("Unsupported query !!");
                
    }

    private String normalizeText(String document) {
