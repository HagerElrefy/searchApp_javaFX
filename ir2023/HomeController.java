...
//import ir_test.algorithms.BiWordIndex;
//import ir_test.algorithms.InvertedIndex;
//import ir_test.algorithms.Lucene;
//import ir_test.algorithms.PositionalIndex;
//import ir_test.algorithms.TermDocumentMatrix;
//import ir_test.util.Utilities;
import algorithms.BiWordIndex;
import algorithms.InvertedIndex;
import algorithms.Lucene;
import algorithms.PositionalIndex;
import algorithms.TermDocumentMatrix;
...
public class HomeController implements Initializable {
    ...
    void onSearchBtnClick() throws IOException {
        ...
        if (!preprocessing.equals(preprocessingInSearch)) {
            ...
            if (searchingIdexChoiceBox.getValue().equals("Term-incidence")) {
                ...
                processAndAnalyzeSearchText(searchText);
                 List<String> split = Arrays.asList(analyzedSearchText.split(" "));
    ...
    private List<String> analyzeQuery(List<String> queryWords) throws IOException {
        ...
        if (preprocessing.contains("Lemetization") && (indexingLemetizationCBox.isSelected())) {
            ...
            lemString = Utilities.lemmatize(lemString);
            newQueryWords = Arrays.asList(lemString.split(" "));
        }
    ...
    private void showSearchResultDocs(List<String> searchResult) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/frontEnd/result-of-documents-list.fxml"));
